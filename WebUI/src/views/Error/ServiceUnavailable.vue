<template>
  <div class="flex column serviceUnavailableBody">
    <div class="serviceUnavailableContainer">
      <div class="errorIcon">
      ...
      <p class="errorDescription">Sorry, the server is temporarily unable to handle the request. Please try again later.</p>
